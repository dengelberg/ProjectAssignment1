...
hist(stepDays, breaks = 8, xlab = "Steps", ylab = "Total Days", main = "Distribution of Steps Taken Each Day")
```
...
The mean of steps is `meanSteps` and the median of steps is `medianSteps`.
